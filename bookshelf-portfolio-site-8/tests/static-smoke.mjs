...
assert.equal(
  structuralHash,
  "fd6dcd6e442cae5c108aa9a6f65c9a181e7592060f862def477b709980670448",
...
assert.match(css, /\.ladder-cat\s*\{[\s\S]*?width:\s*144px;[\s\S]*?height:\s*144px;/,
  "The sleeping cat must be substantially larger than the small shelf props");
assert.match(appSource, /catBody\.width = 144;[\s\S]*?catBody\.height = 144;[\s\S]*?catTail\.width = 36;[\s\S]*?catTail\.height = 90;/,
