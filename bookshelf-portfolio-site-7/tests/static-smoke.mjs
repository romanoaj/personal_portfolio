...
assert.equal(
  structuralHash,
  "3110c6d80e350b76203fe2efdb7db44fb3ea7b7fa779f3e596bfb36054fb9022",
...
assert.match(appSource, /function createLadderScene\(\)[\s\S]*?rungIndex <= 6[\s\S]*?sleeping-cat\.svg[\s\S]*?cat-tail\.svg/,
  "The straight six-rung ladder and sleeping cat scene are missing");
