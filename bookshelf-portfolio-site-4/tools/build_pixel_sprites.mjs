...
sprite("geode", ({ set, row, colors: c }) => {
  // Rounded split stone shell.
  [
    [7,9,14], [8,6,17], [9,4,19], [10,3,20], [11,2,21],
    [12,1,22], [13,1,22], [14,1,22], [15,1,22], [16,1,22],
    [17,1,22], [18,1,22], [19,1,22], [20,2,21], [21,3,20],
    [22,5,18], [23,7,16]
  ].forEach(([y,start,end]) => row(y,start,end,c.outline));
  [
    [8,9,14], [9,7,16], [10,5,18], [11,4,19], [12,3,20],
    [13,2,21], [14,2,21], [15,2,21], [16,2,21], [17,2,21],
    [18,2,21], [19,3,20], [20,4,19], [21,5,18], [22,8,15]
  ].forEach(([y,start,end]) => row(y,start,end,c.stone));
  [[7,10],[8,7],[9,5],[10,4],[11,3],[13,2],[16,2],[19,4],[21,7],
   [7,13],[8,16],[9,18],[10,19],[11,20],[13,21],[16,21],[19,19],[21,16]]
    .forEach(([x,y]) => set(x,y,c.stoneLight));

  // Dark cavity and an irregular amethyst crystal fan.
  [
    [10,8,15], [11,6,17], [12,5,18], [13,5,18], [14,4,19],
    [15,4,19], [16,4,19], [17,5,18], [18,5,18], [19,7,16], [20,9,14]
  ].forEach(([y,start,end]) => row(y,start,end,c.amethystDark));
  [[7,11],[8,10],[8,11],[9,10],[9,11],[9,12],[10,9],[10,10],[10,11],[10,12],[10,13],
   [11,9],[11,10],[11,11],[11,12],[11,13],[12,9],[12,10],[12,11],[12,12],[12,13],[13,9],[13,10],[13,11],[13,12],[13,13],
   [10,7],[11,7],[11,8],[12,6],[12,7],[12,8],[13,6],[13,7],[13,8],[14,6],[14,7],[14,8],[15,6],[15,7],[15,8],
   [11,15],[12,14],[12,15],[12,16],[13,14],[13,15],[13,16],[14,14],[14,15],[14,16],[15,14],[15,15],[15,16],
   [14,5],[15,5],[16,5],[16,6],[17,6],[17,7],[18,7],[18,8],
   [15,17],[16,16],[16,17],[17,15],[17,16],[17,17],[18,15],[18,16]]
    .forEach(([x,y], index) => set(x,y,index % 5 === 0 ? c.amethystLight : c.amethyst));
  [[10,8],[11,9],[7,11],[15,12],[6,15],[16,16],[8,18]].forEach(([x,y]) => set(x,y,c.amethystLight));
});
