...
assert.match(appSource, /catBody\.width = 168;[\s\S]*?catBody\.height = 112;[\s\S]*?catTail\.width = 36;[\s\S]*?catTail\.height = 128;/,
  "The rendered cat and proportionally longer tail dimensions are incorrect");
